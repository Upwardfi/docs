...
module Rouge
    module Themes
      class MonokaiSublimeSlate < CSSTheme
        ...
        palette :light_yellow   => '#f8cb23'
        palette :soft_cyan      => '#66d9ef'
        palette :soft_green    => '#7dbb85'
        ...
        style Name::Variable::Class,
              ...
              Text,
              Name,                             :fg => :white
        style Name::Label,                      :fg => :bright_blue
        style Operator::Word,
              Name::Tag,
              Keyword,
              Keyword::Namespace,
